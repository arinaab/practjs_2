...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(price);
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', price, 'result');
...
var burger = function burger() {
  ...
  burger.addEventListener('click', function () {
    if (menu.style.display == 'none' && window.screen.availWidth <= 992) {
      menu.style.display = 'block'; // menu.classList.remove('animate__fadeInLeft');
    } else {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(size, material, options, promocode, result, state, prop) {
...
var forms = function forms(state) {
  ...
  var checkNumInputs = function checkNumInputs() {
  ...
  upload.forEach(function (item) {
    ...
    item.addEventListener('input', function () {
      ...
      var dots; //переменная для троеточия
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var api; //переменная для формирования пути на сервер
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    var matrix = '+7 (___) ___ __ __',
        //маска, которую мы будем использовать
    i = 0,
        //счетчик
    def = matrix.replace(/\D/g, ''),
        //получаем из матрицы значения, не соответствующие числовым
...
var showMoreStyles = function showMoreStyles(triggerSelector, wrapperSelector) {
...
var sizes = function sizes(imgSelector) {
  ...
  function showImg(block) {
    ...
    block.querySelectorAll('p:not(.sizes-hit)').forEach(function (text) {
